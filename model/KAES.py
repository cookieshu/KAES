...
def cosine_sim(trait1, trait2):
    ...
    normalize_x = tf.nn.l2_normalize(x_masked,0) * mask # mask
    normalize_y = tf.nn.l2_normalize(y_masked,0) * mask # mask
...
def build_KAES(pos_vocab_size, vocab_size, maxnum, maxlen, readability_feature_count,
    ...
    # concatenate with non-prompt-specific features
